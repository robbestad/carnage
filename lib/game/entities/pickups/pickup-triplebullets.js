...
*/
ig.module("game.entities.pickups.pickup-triplebullets").
requires("game.entities.pickups.pickup").
defines(function() {
  EntityPickupTriplebullets = EntityPickup.extend({
    size: {
      x: 40,
      y: 30
    },
    ...
    pickupType:"triplebullets",
    courseAdjusted:false,
    collisionDamage: 0,
    init: function(x, y, settings) {
     this.addAnim("default", 30, [1]);
