...
*/
ig.module("game.entities.pickups.pickup-doublebullets").
requires("game.entities.pickups.pickup").
defines(function() {
  EntityPickupDoublebullets = EntityPickup.extend({
    size: {
      x: 40,
      y: 30
    },
    ...
    pickupType:"doublebullets",
    courseAdjusted:false,
    collisionDamage: 0,
    init: function(x, y, settings) {
     this.addAnim("default", 30, [2]);
